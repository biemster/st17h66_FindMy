...
## Compile
To compile this firmware arm-none-eabi-gcc and CMSIS headers are required. This is still very much a work in progress, mainly the linking is not working yet.
